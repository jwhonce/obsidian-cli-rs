...
use obsidian_cli::{commands::*, types::{OutputStyle, State}};
...
mod command_integration_tests {
    ...
    async fn test_ls_command() {
        ...
        create_test_note(temp_dir.path(), "test2", "title: Second Note", "More content");
    ...
    async fn test_cat_command() {
        ...
        // Create a test file
        create_test_note(temp_dir.path(), "cat-test", "title: Cat Test\ntags: [test]", "# Cat Test\n\nThis is test content for cat command.");
    ...
    async fn test_cat_command_without_extension() {
        ...
        create_test_note(temp_dir.path(), "no-ext-test", "title: No Extension Test", "Content without extension");
    ...
    async fn test_add_uid_command() {
        ...
        create_test_note(temp_dir.path(), "no-uid", "title: No UID Test", "Content without UID");
    ...
    async fn test_add_uid_command_force() {
        ...
        create_test_note(temp_dir.path(), "has-uid", "title: Has UID\nuid: existing-uid-123", "Content with UID");
    ...
    async fn test_edit_command() {
        ...
        // Create a test file
        create_test_note(temp_dir.path(), "edit-test", "title: Edit Test", "Content to edit");
    ...
    async fn test_find_command() {
        ...
        create_test_note(temp_dir.path(), "findable-note", "title: Findable Note", "This note can be found");
        create_test_note(temp_dir.path(), "another-note", "title: Another Note", "This is another note");
    ...
    async fn test_meta_command_list_all() {
        ...
        create_test_note(temp_dir.path(), "meta-test", "title: Meta Test\ntags: [test, meta]\nstatus: draft", "Content with metadata");
    ...
    async fn test_meta_command_get_existing_key() {
        ...
        // Create a test file with frontmatter
        create_test_note(temp_dir.path(), "meta-get", "title: Meta Get Test\nstatus: published", "Content");
    ...
    async fn test_meta_command_set_key() {
        ...
        // Create a test file
        create_test_note(temp_dir.path(), "meta-set", "title: Meta Set Test", "Content");
    ...
    async fn test_query_command_basic() {
        ...
        create_test_note(temp_dir.path(), "query1", "title: Query Test 1\nstatus: published", "Content 1");
        create_test_note(temp_dir.path(), "query2", "title: Query Test 2\nstatus: draft", "Content 2");
        create_test_note(temp_dir.path(), "query3", "title: Query Test 3\nstatus: published", "Content 3");
    ...
    async fn test_query_command_exists() {
        ...
        // Create test files
        create_test_note(temp_dir.path(), "has-tags", "title: Has Tags\ntags: [rust, test]", "Content");
    ...
    async fn test_query_command_missing() {
        ...
        // Create test files
        create_test_note(temp_dir.path(), "has-status", "title: Has Status\nstatus: draft", "Content");
    ...
    async fn test_query_command_count() {
        ...
        // Create test files
        create_test_note(temp_dir.path(), "published1", "title: Published 1\nstatus: published", "Content");
        create_test_note(temp_dir.path(), "published2", "title: Published 2\nstatus: published", "Content");
        create_test_note(temp_dir.path(), "draft1", "title: Draft 1\nstatus: draft", "Content");
    ...
    async fn test_rm_command_force() {
        ...
        create_test_note(temp_dir.path(), "to-delete", "title: To Delete", "This file will be deleted");
    ...
    async fn test_nested_directories() {
        ...
        create_test_note(&temp_dir.path().join("Projects/Rust"), "notes", "title: Rust Notes", "Rust project notes");
    ...
    async fn test_unicode_file_handling() {
        ...
        create_test_note(temp_dir.path(), unicode_name, "title: Unicode Test 🌟", "# Unicode Content\n\nこんにちは世界 🎌");
    ...
    async fn test_large_content_handling() {
        ...
        create_test_note(temp_dir.path(), "large-file", "title: Large File", &large_content);
