...
mod essential_cli_tests {
    ...
    async fn test_cli_basic_info_command() {
        ...
        let args = vec![
            "obsidian-cli",
            "--vault", vault_path.to_str().unwrap(),
            "--editor", "test-editor",
            "info"
        ];
    ...
    async fn test_cli_blacklist_option() {
        ...
        let args = vec![
            ...
            "--vault", vault_path.to_str().unwrap(),
            "--config", config_path.to_str().unwrap(),
            "--blacklist", "cli-override:another-cli-blacklist",
            "info"
        ];
    ...
    async fn test_cli_cat_dispatch() {
        ...
        create_test_note_for_cli(&vault_path, "test-cat", "---\ntitle: Cat Test\n---\nContent");
        
        let args = vec![
            "obsidian-cli",
            "--vault", vault_path.to_str().unwrap(),
            "cat", "--show-frontmatter", "test-cat"
        ];
    ...
    async fn test_cli_meta_view_dispatch() {
        ...
        create_test_note_for_cli(&vault_path, "meta-test", "---\ntitle: Meta Test\n---\nContent");
        
        let args = vec![
            "obsidian-cli",
            "--vault", vault_path.to_str().unwrap(),
            "meta", "--key", "title", "meta-test"
        ];
    ...
    async fn test_cli_query_dispatch() {
        ...
        create_test_note_for_cli(&vault_path, "query-test", "---\nstatus: active\n---\nContent");
        
        let args = vec![
            "obsidian-cli",
            "--vault", vault_path.to_str().unwrap(),
            "query", "--value", "active", "status"
        ];
    ...
    async fn test_cli_query_all_styles() {
        ...
        let args_path = vec![
            "obsidian-cli",
            "--vault", vault_path.to_str().unwrap(),
            "query", "--style", "path", "--value", "test", "type"
        ];
        ...
        let args_title = vec![
            "obsidian-cli",
            "--vault", vault_path.to_str().unwrap(),
            "query", "--style", "title", "--value", "test", "type"
        ];
        ...
        let args_table = vec![
            "obsidian-cli",
            "--vault", vault_path.to_str().unwrap(),
            "query", "--style", "table", "--value", "test", "type"
        ];
        ...
        let args_json = vec![
            "obsidian-cli",
            "--vault", vault_path.to_str().unwrap(),
            "query", "--style", "json", "--value", "test", "type"
        ];
