...
mod template_error_path_tests {
    ...
    fn test_custom_variables_with_special_names() {
        ...
        engine.add_string("var_with_underscores".to_string(), "underscore-value".to_string());
    ...
    fn test_many_variables_in_one_template() {
        ...
        let template = "{year}-{month:02d}-{day:02d}_{month_name}_{month_abbr}_{weekday}_{weekday_abbr}";
        let result = engine.format(template);
